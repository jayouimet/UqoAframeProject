...
const KitchenCounter = (props) => {
    return (
        <a-entity {...props}>
            ...
            <a-box position="0 0.875 0" src="#counterWood" width="1" height="0.05" depth="0.8"></a-box>
            ...
            <a-box position="0 0.925 0.025" color="#EEEEEE" width="1.1" height="0.05" depth="0.85"></a-box>
        </a-entity>
    );
};
